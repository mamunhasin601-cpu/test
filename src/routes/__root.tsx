...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Карточная — карточки и видео для WB и Ozon за 90 секунд" },
      {
        name: "description",
        content:
          "AI-сервис для селлеров маркетплейсов: карточки, инфографика и видеообложки по фото товара или ссылке на карточку конкурента. Первая карточка бесплатно.",
      },
      { name: "author", content: "Карточная" },
      { property: "og:title", content: "Карточная — карточки для WB и Ozon" },
      {
        property: "og:description",
        content:
          "Загрузите фото товара — получите готовую карточку, инфографику и видео за 90 секунд. Оплата по кредитам, без подписок.",
      },
